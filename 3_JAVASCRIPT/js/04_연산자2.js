...
const cv1 = document.getElementById("compareValue1");//L
const cv2 = document.getElementById("compareValue2");//R
...
function checkFn5() {
    ...
    const booli2 = (50 <= 70) && (50 / 4 == 0); 
    console.log(`50은 70 이하이고 4의 배수인가? ${booli2}`);

    const booli3 = 1 <= 13 && 13 <= 10;
    console.log(`13은 1 부터 10 사이의 수가 맞는가? ${booli3}`);
