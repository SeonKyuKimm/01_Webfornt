/* console.log(값) */ 
// 브라우져 내부 콘솔에 괄호() 내부의 값을 출력(기록)

console.log(1234); //사용빈도가 많다
...
// number1, number2 의 합 출력하기 (console.log 안에서 연산가능)
console.log(number1 + number2);

// 변수에 대입한 값 변경하기
number1 = 300; // 기존의 number1에 300 대입(기존 값 10을 덮어쓰기함)
number2 = 400;
...
// 1. var ( 변수, 변수선언 시 중복되는 변수명으로 선언 가능)
