...
function minusFn() {
    ...
    console.log(value1, value2);
    console.log("두 수의 차 : ", Number(value1) - Number(value2));
...
function multiFn() {
    ...
    console.log(value1, value2);
    console.log("두 수의 곱 : ", Number(value1) * Number(value2))
...
function divFn() {
    ...
    console. log("두 수의 분 : ", Number(value1) / Number(value2))
...
function check() {
    ...
    // 전위 연산( ++count, --count)
    // -> count 값이 먼저 증가, 감소된 후 console이 출력
