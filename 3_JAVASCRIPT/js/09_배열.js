...
function check1() {
    ...
    // JS 배열의 특징 : index 별로 자료형을 다르게 할 수 있다.
...
function check4() {
    ...
    //for문 이용해서 배열을 순서대로 초기화 한 후,
    //다른 for문 이용해서 배열 요소를 하나씩 출력
...
function check6() {
    ...
    for(let row = 0; row < 5; row++) {// 행 제어하는 for문
       
        arr[row] = [];
        //arr[0] = []
        //arr[1] = [] 
        for(let col = 0; col < 5; col++) {
            arr[row][col] = count; //row행 col 열에 count 대입
            count += 2; // count를 2 증가
            // arr[0][0] = 2;
            // arr[0][1] = 4;
            // arr[0][2] = 6;
